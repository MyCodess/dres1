...
print ("- un-comment following 2 lines to generate an Error, since an abstract class/subclass can NOT be instatiated whitout implementing all abstractmethos!")
##--chk1-ERROR:   
